...
class TextAdventureGame {
    ...
    // try this if the one above does not work as intended
    /* writeText(message) {
         const msgElement = document.createElement('p');
         msgElement.textContent = message;
         this.gameConsole.appendChild(msgElement);
         this.gameConsole.scrollTop = this.gameConsole.scrollHeight; // Scroll to the bottom
     }*/
